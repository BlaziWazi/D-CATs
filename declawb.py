...
def get_declawb(excel_file):
    ...
    csv.seek(0)
    # Finds the indexes of the necessary CSV columns (MRN and PAVADDOK):
    ...
    for row in csv_reader:
        ...
        if "MRN" in row:
            ...
            for column in row:
                ...
                i += 1
            break
    # Filters the necessary CSV columns (MRN and PAVADDOK), filters the necessary 10-digit numbers from PAVADDOK:
    csv.seek(0)
